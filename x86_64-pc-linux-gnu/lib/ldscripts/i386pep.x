...
SEARCH_DIR("/media/wang/files/CBL-Build/install/x86_64-pep/lib"); SEARCH_DIR("/media/wang/files/CBL-Build/install/lib"); SEARCH_DIR("/usr/local/lib"); SEARCH_DIR("/lib"); SEARCH_DIR("/usr/lib");
SECTIONS
{
